            ...
            <View style ={styles.container}>
                <ScrollView>
                    <View style ={styles.header}>
                        <Image
                            ...
                            source ={{image:require("../assets/african-cuisine-6697867_640.jpg")}}
                        />
                     </View>
                     ...
                     <View style ={styles.view4}>
                        <View style ={styles.view5}>
                            ...
                            <Text style ={styles.text6}>TZS{price.toFixed(2)}</Text>
                        </View>
                     </View>
                     <View>
                ...
                <View style ={styles.view17}>
                    <View style ={styles.view18}>
                        <Text style ={styles.text10}>Add 1 to Cart TZS17500.00</Text>
                    </View>
                </View>
            </View>
        )
